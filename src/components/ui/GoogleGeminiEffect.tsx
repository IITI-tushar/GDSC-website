...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky top-60", className)}>
      ...
      >
        <motion.p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300">
      ...
      >
        <Cover><p className="text-2xl font-bold text-white"><TextGenerateEffect words={description || ""} /></p></Cover>
      </motion.div>
